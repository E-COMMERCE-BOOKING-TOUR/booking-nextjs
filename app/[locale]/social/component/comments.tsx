            ...
            <Flex gap={3} mt={4} pl={depth ? 8 : 0}>
                ...
                <VStack align="start" gap={1} flex={1}>
                    ...
                    <HStack gap={4} fontSize="xs" color="gray.500" mt={0.5}>
                        ...
                        <Text fontWeight="semibold" cursor="pointer" onClick={() => handleReply(node)}>{t('reply', { defaultValue: 'Reply' })}</Text>
                    </HStack>
                            ...
                            {!isOpenChild ? (
                                <HStack gap={2} cursor="pointer" onClick={() => toggle(node.id)}>
                                    ...
                                    <Text fontSize="xs" color="gray.500" fontWeight="semibold">
                                        {t('view_replies', { count: node.children.length, defaultValue: `View replies (${node.children.length})` })}
                                    </Text>
                                </HStack>
                            ) : null}
                        </Box>
                        ...
                        <Grid templateColumns={{ base: "1fr", md: "1.2fr 1fr" }} h="full">
                            ...
                            <GridItem h="full" display="flex" flexDirection="column" bg="black">
                                    ...
                                    {nodes.length > 0 ? (
                                        ...
                                        !caption && (
                                            <Box py={10} textAlign="center">
                                                <Text color="gray.500" fontSize="sm">{t('no_comments_yet', { defaultValue: 'No comments yet.' })}</Text>
                                                <Text color="gray.500" fontSize="xs">{t('start_conversation', { defaultValue: 'Start the conversation.' })}</Text>
                                            </Box>
                                        )
                                    )}
                                </Box>
                                ...
                                <Box p={4} borderTop="1px solid" borderColor="whiteAlpha.200">
                                    ...
                                    <Text fontWeight="bold" fontSize="sm" mb={1}>{likeCount || 0} {t('likes', { defaultValue: 'likes' })}</Text>
                                    <Text fontSize="xs" color="gray.500" textTransform="uppercase" mb={4}>{createdAt ? dateFormat(createdAt) : t('just_now', { defaultValue: 'Just now' })}</Text>
