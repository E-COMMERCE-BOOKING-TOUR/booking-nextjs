                ...
                <HStack gap={4}>
                    ...
                    <VStack align="start" gap={1}>
                        ...
                        <Text color="gray.500" fontSize="sm">
                            {t('booking_created_at', { defaultValue: 'Created at:' })} {new Date().toLocaleDateString(locale === 'vi' ? 'vi-VN' : 'en-US')}
                        </Text>
                    </VStack>
                </HStack>
                                            ...
                                            <VStack align="stretch" gap={2}>
                                                <HStack justify="space-between">
                                                    ...
                                                    <Text fontWeight="bold" color="red.600">
                                                        {refundInfo.feeAmount.toLocaleString(locale === 'vi' ? 'vi-VN' : 'en-US')} {b.currency}
                                                    </Text>
                                                </HStack>
                                                <Separator />
                                                <HStack justify="space-between">
                                                    ...
                                                    <Text fontWeight="black" color="green.600" fontSize="lg">
                                                        {refundInfo.refundAmount.toLocaleString(locale === 'vi' ? 'vi-VN' : 'en-US')} {b.currency}
                                                    </Text>
                                                </HStack>
                                            </VStack>
                                        </Box>
                                ...
                                <VStack align="start" gap={2}>
                                    ...
                                    <HStack gap={4} mt={2}>
                                        <HStack color="blue.600" fontWeight="bold" fontSize="sm">
                                            ...
                                            <Text>{new Date(b.start_date).toLocaleDateString(locale === 'vi' ? 'vi-VN' : 'en-US')}</Text>
                                        </HStack>
                                    ...
                                    {b.items.map((item, idx) => (
                                        <Table.Row key={idx}>
                                            ...
                                            <Table.Cell textAlign="right">
                                                {Number(item.unit_price).toLocaleString(locale === 'vi' ? 'vi-VN' : 'en-US')} {b.currency}
                                            </Table.Cell>
                                            <Table.Cell textAlign="right" fontWeight="bold">
                                                {Number(item.total_amount).toLocaleString(locale === 'vi' ? 'vi-VN' : 'en-US')} {b.currency}
                                            </Table.Cell>
                                        </Table.Row>
                                    ))}
                                </Table.Body>
