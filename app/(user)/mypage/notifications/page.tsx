        ...
        <VStack align="stretch" gap={4}>
            <HStack justify="space-between">
                <VStack align="start" gap={1}>
                    <Heading fontSize="lg" fontWeight="bold" textTransform="uppercase">Notifications</Heading>
                    <Text color="gray.500" fontSize="sm">Stay updated with your booking status and travel alerts</Text>
                </VStack>
                {totalCount > 0 && (
                    <Badge colorPalette="orange" variant="solid" px={3} py={1} rounded="full">
                        {totalCount} Total
                    </Badge>
                )}
            </HStack>
                ...
                <Box py={20} textAlign="center">
                    <VStack gap={4}>
                        <Box p={6} bg="gray.50" rounded="full">
                            <FiBell size={40} color="#CBD5E0" />
                        </Box>
                        <Text color="gray.500" fontWeight="medium">You have no notifications yet.</Text>
                    </VStack>
                </Box>
            ) : (
                <VStack align="stretch" gap={4}>
