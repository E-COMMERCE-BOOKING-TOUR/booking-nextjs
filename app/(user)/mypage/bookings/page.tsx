        ...
        <VStack align="stretch" gap={4}>
            <HStack justify="space-between">
                <VStack align="start" gap={1}>
                    <Heading fontSize="lg" fontWeight="bold" textTransform="uppercase">My Bookings</Heading>
                    <Text color="gray.500" fontSize="sm">Track and manage your travel adventures</Text>
                </VStack>
                                    ...
                                    <VStack align="start" gap={2}>
                                        ...
                                        <HStack gap={4}>
                                            <HStack color="gray.500" fontSize="xs">
                                                ...
                                                <Text>{booking.start_date ? new Date(booking.start_date).toLocaleDateString('vi-VN') : 'N/A'}</Text>
                                            </HStack>
