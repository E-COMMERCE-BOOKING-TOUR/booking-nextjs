                                    ...
                                    <VStack align="start" gap={2}>
                                        ...
                                        <HStack gap={4}>
                                            <HStack color="gray.500" fontSize="xs">
                                                ...
                                                <Text>{booking.start_date ? new Date(booking.start_date).toLocaleDateString(lng === 'vi' ? 'vi-VN' : 'en-US') : 'N/A'}</Text>
                                            </HStack>
                                            <Text fontWeight="black" color="blue.600" fontSize="sm">
                                                {Number(booking.total_amount).toLocaleString(lng === 'vi' ? 'vi-VN' : 'en-US')} {booking.currency}
                                            </Text>
                                        </HStack>
                                    </VStack>
