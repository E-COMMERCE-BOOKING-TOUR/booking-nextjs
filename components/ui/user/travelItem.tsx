...
const LargeTravelItem = ({ image, title, toursCount, flag = "🇻🇳" }: TravelItemProps) => (
  <Box
    position="relative"
    w="full"
    h="220px"
...
const SmallTravelItem = ({ image, title, toursCount, flag = "🇻🇳" }: TravelItemProps) => (
  <Box
    position="relative"
    w="full"
    h="160px"
...
TravelItem.large = function (props: TravelItemProps) {
  return <LargeTravelItem {...props} />;
};
